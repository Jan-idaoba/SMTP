...
#pragma comment(lib, "C:\\Users\\appeon\\Desktop\\TestCurlSMTP\\TestCurlSMTP\\Debug\\libcurl_debug.lib")
   ...
   */
    ...
    */
#define FROM_ADDR    "<zengzhaofa@dev.appeon.net>"
#define TO_ADDR      "<zengzhaofa@dev.appeon.net>"
...
int main(void)
{
    ...
    if (curl) {
        ...
        res = curl_easy_setopt(curl, CURLOPT_URL, "smtp://mail.dev.appeon.net:587");
        res = curl_easy_setopt(curl, CURLOPT_USERNAME, "zengzhaofa@dev.appeon.net");
